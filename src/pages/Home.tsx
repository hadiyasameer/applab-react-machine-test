...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <div className={`fixed top-0 right-0 h-full w-full sm:w-[450px] bg-white z-50 shadow-2xl transform transition-transform duration-300 ease-in-out ${isCartOpen ? 'translate-x-0' : 'translate-x-full'}`}>
